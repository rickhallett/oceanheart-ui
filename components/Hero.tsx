  ...
  return (
    <>
      <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-center">
          ...
          <Image src="/images/logo_v1.png" alt="myThera" width={200} height={200} />
          <p className="text-lg opacity-80 leading-relaxed -mt-4">
            <span className="font-bold text-blue-400">"myThera"</span>: We can build a custom AI model that helps you reflect on your life. And your data doesn't go anywhere. Ever.{' '}

          </p>
          <a href="https://calendar.app.google/85ZdaqYK5vfNk4aH9" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline -mt-8">Book a free 20-min call</a>
          {user ? (
