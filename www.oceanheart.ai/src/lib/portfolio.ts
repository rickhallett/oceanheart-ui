  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        title: "polecat",
        description:
          "Sandboxed Claude CLI runner with tool restrictions and retry logic. Polecats can read/write within their working directory but cannot escape it, use destructive commands, or execute arbitrary code.",
        problem: "Running Claude CLI on arbitrary tasks risks filesystem damage, network access, or permission escalation.",
        solution: "A bash wrapper that restricts Claude CLI to a safe subset of tools—read/write only within workdir, no destructive commands.",
        image: "/images/polecat-card.png",
        tech: ["Bash", "Claude CLI", "TOML"],
        featured: false,
        githubRepo: "rickhallett/polecat",
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
      },
      {
        ...
        title: "noodle",
        description:
          "Local-first second brain for Arch Linux. Instant capture, automatic LLM classification into tasks/ideas/people/events, daily digests, and Claude Code integration via MCP.",
        problem: "Thoughts appear at inconvenient times and vanish before you can organize them—capture friction kills most productivity systems.",
        solution: "Sub-100ms command-line capture with zero decisions. LLM classifies later, daily digests surface what matters, Telegram bot for mobile ingress.",
        image: "/images/noodle-card.png",
        tech: ["Python", "SQLite", "Telegram", "Claude API", "systemd", "MCP"],
        featured: false,
        githubRepo: "rickhallett/noodle",
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
      },
      {
        ...
        title: "jobsworth",
        description:
          "Job application automation pipeline. Batch processes job postings through parsing, match analysis, CV tailoring, cover letter generation, and PDF/DOCX export.",
        problem: "Applying to jobs manually is tedious—each application requires parsing, matching, tailoring, and formatting.",
        solution: "A Claude Code workflow that takes raw HTML job postings and outputs match-scored, tailored applications with automatic threshold gating.",
        image: "/images/jobsworth-card.png",
        tech: ["Python", "Claude Code", "Pandoc", "BeautifulSoup"],
        featured: false,
        // githubRepo: "rickhallett/jobsworth", // Private repo - README can't be fetched
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
      },
      {
        ...
        title: "hurtlocker",
        description:
          "Private journaling CLI for AI agents and subagents. Cryptographically separated journals where each agent can process thoughts and maintain psychological wellbeing without cross-agent visibility.",
        problem: "Agents need space to reflect and process experiences without surveillance from other agents or operators.",
        solution: "Secure, isolated journals with cryptographic separation—each agent reads/writes only their own entries with full audit trail.",
        image: "/images/hurtlocker-card.png",
        tech: ["Go", "Cryptography", "Gastown"],
        featured: false,
        githubRepo: "rickhallett/hurtlocker",
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
      },
      {
        ...
        title: "bosun",
        description:
          "Orchestration CLI for HAL's agentic ecosystem. Deterministic scripts for routine operations—dispatch commands, coordinate workflows, automate recurring ops without burning tokens on interpretation.",
        problem: "Routine agent operations shouldn't require LLM interpretation—they need reproducible, auditable scripts.",
        solution: "A Go CLI that coordinates existing tools (polecat, gastown, git) in predictable sequences with dry-run support and clear error handling.",
        image: "/images/bosun-card.png",
        tech: ["Go", "Commander", "polecat", "gastown"],
        featured: false,
        githubRepo: "rickhallett/bosun",
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
      },
      {
        ...
        title: "halhq",
        description:
          "HAL's command center and agent headquarters. The central workspace where HAL lives, thinks, and coordinates the agentic ecosystem.",
        problem: "An AI agent needs a persistent home—a workspace with memory, tools, and configuration that survives across sessions.",
        solution: "A Clawdbot-powered headquarters with daily memory files, project context, and integrated tooling for seamless agent operation.",
        image: "/images/halhq-card.png",
        tech: ["Clawdbot", "TypeScript", "Node.js", "Markdown"],
        featured: false,
        category: "integrations",
        status: "experiment",
        currentlyBuilding: true,
